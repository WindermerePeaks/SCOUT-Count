...
class network(nn.Module):
	...
	def forward(self, x, stylization=False, out_prob=False, return_style_features=False, teacher_mode=False,visualize=False, calculate_cov=False, apply_sscwl=False):
